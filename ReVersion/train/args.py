...
def parse_args():
	...
	parser.add_argument(
		...
		action="store_true",
		default=False,
		help="Use SDXL rather than SD 1.5",
	)
...
def get_chkpt_path(resume_from_checkpoint: Union[str, None], output_dir: str):
	# Potentially load in the weights and states from a previous save
	if resume_from_checkpoint and resume_from_checkpoint != "latest":
